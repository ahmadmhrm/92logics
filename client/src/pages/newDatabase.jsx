...
import { CREATE_DATABASE_RESET } from "../constants/databaseConstant";
...
const NewDatabase = () => {
  ...
  const createDatabaseSubmitHandler = (e) => {
    ...
    dispatch(databaseContent(myForm));
  };

  const createDatabaseIconChange = (e) => {
      ...
      <div className="dashboard">
        ...
        <div className="newProductContainer">
          <form
            ...
            onSubmit={createDatabaseSubmitHandler}
          >
            ...
            <div id="createProductFormFile">
              ...
              <input
                ...
                name="icon"
                accept="image/*"
                onChange={createDatabaseIconChange}
              />
            </div>
            <Button
              id="createProductBtn"
